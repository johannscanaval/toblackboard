...
# Escribe aquí las rutas de los archivos a leer.
# Usa la forma en la que tu Sistema Operativo lea direcciones.
# Por ejemplo en Linux es de la forma '/home/user-name/folder/file.csv'

ruta_sicua='sicua3.xls'
ruta_nearpod='datos_entrada.csv'

#El nombre que coloque aquí, será el nombre de la columna en Excel
column_name='Quizz 99'
